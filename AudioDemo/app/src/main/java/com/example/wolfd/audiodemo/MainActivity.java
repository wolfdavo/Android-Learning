package com.example.wolfd.audiodemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayer = MediaPlayer.create(this, R.raw.cyclone);
        final int maxProgress = mPlayer.getDuration();
        ...
        final SeekBar seekControl = (SeekBar) findViewById(R.id.posSeek);
        seekControl.setMax(maxProgress);
